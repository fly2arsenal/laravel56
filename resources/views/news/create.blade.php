...
@section('content')
    @parent
    <div class="row">
        {!! Form::open(['url' => route("createNews"), 'method' => 'post', 'enctype' => "multipart/form-data"]) !!}
          <div class="col-md-8">
                  ...
                  <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                          ...
                          <span><strong class="text-danger">*</strong></span>
                          {{ Form::text('content', old('content'), ['class' => 'form-control', 'placeholder' => 'Enter Content', 'required' => 'required']) }}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
